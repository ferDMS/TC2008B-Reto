...
obstacle1 = load('Obstacle_1.txt');
obstacle2 = load('Obstacle_2.txt');
obstacle3 = load('Obstacle_3.txt');
obstacle4 = load('Obstacle_4.txt');
obstacle5 = load('Obstacle_5.txt');
obstacle6 = load('Obstacle_6.txt');
targets_robot1 = load('Robot_1_Path.txt'); % Path coordinates for Robot 1
targets_robot2 = load('Robot_2_Path.txt'); % Path coordinates for Robot 2
